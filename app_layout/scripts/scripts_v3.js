$(document).ready(function(){
    ...
    $(".build").on("click", function(){
      if (d3.select("#viewsection").attr("hidden") != "hidden"){
        ...
        setTimeout(function(){
          $(".mynav-button").animate({top: '-200px'}, {queue: true, duration: 500});
    ...
    $("#brand").on("click", function(){
      //this may be different on your local machine
      window.location.href = "index.html";
    });

    $(".generate").on("click", function(){
        clear_vis();
        var selected = d3.select(".vis-select-container.vis-list-selected").attr("value");
        ...
        setTimeout(function(){
          $(".mynav-button").animate({top: '0px'}, {queue: true, duration: 500});
        }, 500);
    });
