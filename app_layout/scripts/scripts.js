...
var arc = d3.arc()
    ...
    d3.json("scripts/falseData.json", function(error, root) {
     ...
     /*function loadJSON(callback) {
        ...
        xobj.open('GET', 'scripts/falseData.json', true); // Replace 'my_data' with the path to your file
...
$(document).ready(function(){
    ...
    $(".vis-drop").click(function () {
      if ($("#vis-select").is( ":hidden" ) ) {
        ...
        $("#vis-select").slideUp( "fast" );
      }
    });

    $(".msg-drop").click(function () {
      if ($("#msg-select").is( ":hidden" ) ) {
        $("#msg-select").slideDown( "fast" );
      } else {
...
Sunburst with legend and center label and hover, adapt this to our app
http://bl.ocks.org/chrisrzhou/d5bdd8546f64ca0e4366
